...
-- Records of tb_user
-- ----------------------------
INSERT INTO `mybatis-test`.`tbl_user`(`id`, `age`, `name`, `address`) VALUES (1, 12, 'lisi', '中文');
INSERT INTO `mybatis-test`.`tbl_user`(`id`, `age`, `name`, `address`) VALUES (2, 13, '小米', '碑亭情谊');
INSERT INTO `mybatis-test`.`tbl_user`(`id`, `age`, `name`, `address`) VALUES (8, 14, 'zhangsan', 'beijingchaoyang');
INSERT INTO `mybatis-test`.`tbl_user`(`id`, `age`, `name`, `address`) VALUES (9, 15, 'lisi', 'shanghai');